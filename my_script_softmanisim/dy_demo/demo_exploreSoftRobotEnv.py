...
if __name__ == "__main__":
    ...
    env = SoftRobotBasicEnvironment(number_of_sphere=30, 
                                    number_of_segment=3, 
                                    body_color=[1, 0, 0, 1])
    # env.create_robot()
    ...
    # please add User debug parameter for other cables
    sf1_seg1_cable_1_Slider = p.addUserDebugParameter("sf1_seg1_cable_1", -0.05, 0.05, 0)
    sf1_seg1_cable_2_Slider = p.addUserDebugParameter("sf1_seg1_cable_2", -0.05, 0.05, 0)
    sf1_seg2_cable_1_Slider = p.addUserDebugParameter("sf1_seg2_cable_1", -0.05, 0.05, 0)
    sf1_seg2_cable_2_Slider = p.addUserDebugParameter("sf1_seg2_cable_2", -0.05, 0.05, 0)
    ...
    while True:
        ...
        sf1_seg1_cable_1 = p.readUserDebugParameter(sf1_seg1_cable_1_Slider)
        sf1_seg1_cable_2 = p.readUserDebugParameter(sf1_seg1_cable_2_Slider)
        sf1_seg2_cable_1 = p.readUserDebugParameter(sf1_seg2_cable_1_Slider)
        sf1_seg2_cable_2 = p.readUserDebugParameter(sf1_seg2_cable_2_Slider)
